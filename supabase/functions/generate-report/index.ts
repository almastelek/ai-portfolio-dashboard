...
serve(async (req) => {
  ...
  try {
    ...
    // Get user's portfolios using service role key to bypass RLS
    ...
    // Get holdings for all user's portfolios
    ...
    // Enhanced content generation with much more detail
    let report = {}
