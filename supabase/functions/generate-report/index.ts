      ...
      report = {
        ...
        sections: {
          market_overview: {
            ...
            content: `Markets are positioning ahead of today's session. Your portfolio of ${totalHoldings} positions valued at $${totalValue.toLocaleString()} is exposed to multiple sectors that could see movement today.`,
            key_themes: [
